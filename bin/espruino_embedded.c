...
static __attribute__ ((gnu_inline)) inline bool isWhitespaceInline(char ch) {
    return (ch==0x09) ||
           (ch==0x0B) ||
           (ch==0x0C) ||
           (ch==0x20) ||
...
static __attribute__ ((gnu_inline)) inline bool isAlphaInline(char ch) {
    return ((ch>='a') && (ch<='z')) || ((ch>='A') && (ch<='Z')) || ch=='_';
}
static __attribute__ ((gnu_inline)) inline bool isNumericInline(char ch) {
    return (ch>='0') && (ch<='9');
}
...
static __attribute__ ((gnu_inline)) inline void itostr(JsVarInt val,char *str,unsigned int base) {
...
static __attribute__ ((gnu_inline)) inline JsVar *jsvNewFromEmptyString() { return jsvNewWithFlags(JSV_STRING_0); } ;
static __attribute__ ((gnu_inline)) inline JsVar *jsvNewNull() { return jsvNewWithFlags(JSV_NULL); } ;
...
static __attribute__ ((gnu_inline)) inline bool jsvHasRef(const JsVar *v) { return !jsvIsStringExt(v); }
...
static __attribute__ ((gnu_inline)) inline void jsvAppendCharacter(JsVar *var, char ch) { jsvAppendStringBuf(var, &ch, 1); };
...
static __attribute__ ((gnu_inline)) inline JsVarInt _jsvGetIntegerAndUnLock(JsVar *v) { JsVarInt i = jsvGetInteger(v); jsvUnLock(v); return i; }
static __attribute__ ((gnu_inline)) inline JsVarFloat _jsvGetFloatAndUnLock(JsVar *v) { JsVarFloat f = jsvGetFloat(v); jsvUnLock(v); return f; }
static __attribute__ ((gnu_inline)) inline bool _jsvGetBoolAndUnLock(JsVar *v) { bool b = jsvGetBool(v); jsvUnLock(v); return b; }
...
static __attribute__ ((gnu_inline)) inline char jsvStringIteratorGetChar(JsvStringIterator *it) {
  if (!it->ptr) return 0;
...
static __attribute__ ((gnu_inline)) inline bool jsvStringIteratorHasChar(JsvStringIterator *it) {
...
static __attribute__ ((gnu_inline)) inline size_t jsvStringIteratorGetIndex(JsvStringIterator *it) {
...
static __attribute__ ((gnu_inline)) inline void jsvStringIteratorLoadInline(JsvStringIterator *it) {
...
static __attribute__ ((gnu_inline)) inline void jsvStringIteratorNextInline(JsvStringIterator *it) {
  it->charIdx++;
...
static __attribute__ ((gnu_inline)) inline void jsvStringIteratorFree(JsvStringIterator *it) {
  jsvUnLock(it->var);
}
...
static __attribute__ ((gnu_inline)) inline JsVar *jsvObjectIteratorGetKey(JsvObjectIterator *it) {
  if (!it->var) return 0;
  return jsvLockAgain(it->var);
}
static __attribute__ ((gnu_inline)) inline JsVar *jsvObjectIteratorGetValue(JsvObjectIterator *it) {
  if (!it->var) return 0;
  return jsvSkipName(it->var);
}
static __attribute__ ((gnu_inline)) inline bool jsvObjectIteratorHasValue(JsvObjectIterator *it) {
  return it->var != 0;
}
...
static __attribute__ ((gnu_inline)) inline void jsvObjectIteratorFree(JsvObjectIterator *it) {
  jsvUnLock(it->var);
}
...
typedef enum {
  ...
  EXEC_PERSIST = EXEC_ERROR_MASK|EXEC_CTRL_C_MASK|EXEC_RUN_INTERRUPT_JS,
} JsExecFlags;
typedef struct {
  JsVar *root;
  JsVar *hiddenRoot;
...
static __attribute__ ((gnu_inline)) inline char jslNextCh() {
...
static __attribute__ ((gnu_inline)) inline void jslTokenAppendChar(char ch) {
  if (lex->tokenl < 64 -1) {
...
static __attribute__ ((gnu_inline)) inline void jslSingleChar() {
...
static void jslGetRawString() {
  do { if (!(lex->tk == LEX_RAW_STRING8 || lex->tk == LEX_RAW_STRING16)) jsAssertFail("bin/espruino_embedded.c",591,""); } while(0);
...
void jslGetNextToken() {
  ...
  switch(jslJumpTable[jumpCh]) {
    ...
    case JSLJT_ID: {
      ...
      default: do { if (!(0)) jsAssertFail("bin/espruino_embedded.c",933,""); } while(0);break;
    }
  }
}
static __attribute__ ((gnu_inline)) inline void jslPreload() {
  jslGetNextCh();
  jslGetNextToken();
}
void jslInit(JsVar *var) {
  do { if (!(jsvIsString(var))) jsAssertFail("bin/espruino_embedded.c",945,""); } while(0);
...
const char* jslReservedWordAsString(int token) {
  ...
  do { if (!(n==0)) jsAssertFail("bin/espruino_embedded.c",1091,""); } while(0);
  return &tokenNames[p];
}
void jslTokenAsString(int token, char *str, size_t len) {
  do { if (!(len>28)) jsAssertFail("bin/espruino_embedded.c",1096,""); } while(0);
  if (token>32 && token<128) {
    do { if (!(len>=4)) jsAssertFail("bin/espruino_embedded.c",1099,""); } while(0);
    str[0] = '\'';
    str[1] = (char)token;
    str[2] = '\'';
    str[3] = 0;
...
char *jslGetTokenValueAsString() {
  ...
  do { if (!(lex->tokenl < 64)) jsAssertFail("bin/espruino_embedded.c",1144,""); } while(0);
...
JsVar *jslGetTokenValueAsVar() {
  if (lex->tokenValue) {
    ...
    do { if (!(lex->tokenl < 64)) jsAssertFail("bin/espruino_embedded.c",1170,""); } while(0);
    lex->token[lex->tokenl] = 0;
...
JsVar *jslNewStringFromLexer(JslCharPos *charFrom, size_t charTo) {
  ...
  do { if (!(maxLength>0)) jsAssertFail("bin/espruino_embedded.c",1370,""); } while(0);
  JsVar *var = 0;
  ...
  jsvSetCharactersInVar(block, blockChars);
  jsvUnLock(block);
  do { if (!((totalStringLength == jsvGetStringLength(var)) || (jsErrorFlags&JSERR_MEMORY) || !jsvStringIteratorHasChar(&it))) jsAssertFail("bin/espruino_embedded.c",1423,""); } while(0);
  jsvStringIteratorFree(&it);
  return var;
}
bool jslNeedSpaceBetween(unsigned char lastch, unsigned char ch) {
...
void jslPrintTokenLineMarker(vcbprintf_callback user_callback, void *user_data, JsLex *lex, size_t tokenPos, size_t prefixLength) {
  size_t line = 1;
  size_t colx = 1;
  jsvGetLineAndCol(lex->sourceVar, tokenPos, &line, &colx, NULL);
  int col = (int)colx;
...
bool jshPushCustomEvent(IOCustomEventFlags customFlags);
...
extern JsVar *timerArray;
extern JsVar *watchArray;
...
static __attribute__ ((gnu_inline)) inline JsVar *jsvGetAddressOf(JsVarRef ref) {
  do { if (!(ref)) jsAssertFail("bin/espruino_embedded.c",1873,""); } while(0);
  do { if (!(ref <= jsVarsSize)) jsAssertFail("bin/espruino_embedded.c",1879,""); } while(0);
  return &jsVars[ref-1];
}
JsVar *_jsvGetAddressOf(JsVarRef ref) {
...
void jsvSetMaxVarsUsed(unsigned int size) {
  do { if (!(size < 16000)) jsAssertFail("bin/espruino_embedded.c",1898,""); } while(0);
  jsVarsSize = size;
}
void jsvCreateEmptyVarList() {
  do { if (!(!isMemoryBusy)) jsAssertFail("bin/espruino_embedded.c",1909,""); } while(0);
...
void jsvClearEmptyVarList() {
  do { if (!(!isMemoryBusy)) jsAssertFail("bin/espruino_embedded.c",1936,""); } while(0);
  isMemoryBusy = MEMBUSY_SYSTEM;
  jsVarFirstEmpty = 0;
  JsVarRef i;
  for (i=1;i<=jsVarsSize;i++) {
...
void jsvSetMemoryTotal(unsigned int jsNewVarCount) {
  ( (void)(jsNewVarCount) );
  do { if (!(0)) jsAssertFail("bin/espruino_embedded.c",2104,""); } while(0);
}
void jsvUpdateMemoryAddress(size_t oldAddr, size_t length, size_t newAddr) {
  for (unsigned int i=1;i<=jsVarsSize;i++) {
    JsVar *v = jsvGetAddressOf((JsVarRef)i);
...
size_t jsvGetMaxCharactersInVar(const JsVar *v) {
  ...
  do { if (!(jsvHasCharacterData(v))) jsAssertFail("bin/espruino_embedded.c",2160,""); } while(0);
...
size_t jsvGetCharactersInVar(const JsVar *v) {
  ...
  do { if (!(f >= JSV_NAME_STRING_INT_0)) jsAssertFail("bin/espruino_embedded.c",2179,""); } while(0);
  do { if (!((JSV_NAME_STRING_INT_0 < JSV_NAME_STRING_0) && (JSV_NAME_STRING_0 < JSV_STRING_0) && (JSV_STRING_0 < JSV_STRING_EXT_0))) jsAssertFail("bin/espruino_embedded.c",2180,""); } while(0);
  if (f<=JSV_NAME_STRING_MAX) {
    ...
    do { if (!(f <= JSV_STRING_EXT_MAX)) jsAssertFail("bin/espruino_embedded.c",2190,""); } while(0);
    return f - JSV_STRING_EXT_0;
  }
}
void jsvSetCharactersInVar(JsVar *v, size_t chars) {
  unsigned int f = v->flags&JSV_VARTYPEMASK;
  do { if (!(!(jsvIsFlatString(v) || jsvIsNativeString(v) || jsvIsFlashString(v)))) jsAssertFail("bin/espruino_embedded.c",2198,""); } while(0);
  JsVarFlags m = (JsVarFlags)(v->flags&~JSV_VARTYPEMASK);
  do { if (!(f >= JSV_NAME_STRING_INT_0)) jsAssertFail("bin/espruino_embedded.c",2201,""); } while(0);
  do { if (!((JSV_NAME_STRING_INT_0 < JSV_NAME_STRING_0) && (JSV_NAME_STRING_0 < JSV_STRING_0) && (JSV_STRING_0 < JSV_STRING_EXT_0))) jsAssertFail("bin/espruino_embedded.c",2202,""); } while(0);
  if (f<=JSV_NAME_STRING_MAX) {
    do { if (!(chars <= 4)) jsAssertFail("bin/espruino_embedded.c",2206,""); } while(0);
    if (f<=JSV_NAME_STRING_INT_MAX)
    ...
    if (f<=JSV_STRING_MAX) {
      do { if (!(chars <= (4 + ((14*3 + 0)>>3)))) jsAssertFail("bin/espruino_embedded.c",2213,""); } while(0);
      v->flags = (JsVarFlags)(m | (JSV_STRING_0+chars));
    } else {
      do { if (!(chars <= (4 + ((14*3 + 0 + 8)>>3)))) jsAssertFail("bin/espruino_embedded.c",2216,""); } while(0);
      do { if (!(f <= JSV_STRING_EXT_MAX)) jsAssertFail("bin/espruino_embedded.c",2217,""); } while(0);
      v->flags = (JsVarFlags)(m | (JSV_STRING_EXT_0+chars));
    }
  }
}
void jsvResetVariable(JsVar *v, JsVarFlags flags) {
  do { if (!((v->flags&JSV_VARTYPEMASK) == JSV_UNUSED)) jsAssertFail("bin/espruino_embedded.c",2224,""); } while(0);
  do { if (!(!(flags & JSV_LOCK_MASK))) jsAssertFail("bin/espruino_embedded.c",2225,""); } while(0);
  unsigned int i;
  if ((sizeof(JsVar)&3) == 0) {
...
JsVar *jsvNewWithFlags(JsVarFlags flags) {
  ...
  jshInterruptOn();
  if (v) {
    do { if (!(v->flags == JSV_UNUSED)) jsAssertFail("bin/espruino_embedded.c",2262,""); } while(0);
...
static void jsvFreePtrInternal(JsVar *var) {
  do { if (!(jsvGetLocks(var)==0)) jsAssertFail("bin/espruino_embedded.c",2313,""); } while(0);
...
__attribute__ ((gnu_inline)) inline void jsvFreePtr(JsVar *var) {
  do { if (!((!jsvGetNextSibling(var) && !jsvGetPrevSibling(var)) || jsvIsRefUsedForData(var) || (jsvIsName(var) && (jsvGetNextSibling(var)==jsvGetPrevSibling(var))))) jsAssertFail("bin/espruino_embedded.c",2346,""); } while(0);
  ...
  if (jsvHasChildren(var)) {
    ...
    while (childref) {
      ...
      do { if (!(jsvIsName(child))) jsAssertFail("bin/espruino_embedded.c",2429,""); } while(0);
    ...
    if (jsvIsName(var)) {
      do { if (!(jsvGetNextSibling(var)==jsvGetPrevSibling(var))) jsAssertFail("bin/espruino_embedded.c",2442,""); } while(0);
...
JsVar *jsvLockAgain(JsVar *var) {
  do { if (!(var)) jsAssertFail("bin/espruino_embedded.c",2488,""); } while(0);
  if ((var->flags & JSV_LOCK_MASK)!=JSV_LOCK_MASK)
    var->flags += JSV_LOCK_ONE;
  return var;
}
...
static __attribute__ ((noinline)) void jsvUnLockFreeIfNeeded(JsVar *var) {
  do { if (!(jsvGetLocks(var) == 0)) jsAssertFail("bin/espruino_embedded.c",2502,""); } while(0);
  if (jsvGetRefs(var) == 0 &&
      jsvHasRef(var) &&
...
static __attribute__ ((gnu_inline)) inline void jsvUnLockInline(JsVar *var) {
  if (!var) return;
  do { if (!(jsvGetLocks(var)>0)) jsAssertFail("bin/espruino_embedded.c",2518,""); } while(0);
...
JsVar *jsvRef(JsVar *var) {
  do { if (!(var && jsvHasRef(var))) jsAssertFail("bin/espruino_embedded.c",2560,""); } while(0);
  if (jsvGetRefs(var) < ((1<<8)-1))
    jsvSetRefs(var, (JsVarRefCounter)(jsvGetRefs(var)+1));
  do { if (!(jsvGetRefs(var))) jsAssertFail("bin/espruino_embedded.c",2563,""); } while(0);
  return var;
}
void jsvUnRef(JsVar *var) {
  do { if (!(var && jsvGetRefs(var)>0 && jsvHasRef(var))) jsAssertFail("bin/espruino_embedded.c",2569,""); } while(0);
...
JsVarRef jsvRefRef(JsVarRef ref) {
  JsVar *v;
  do { if (!(ref)) jsAssertFail("bin/espruino_embedded.c",2583,""); } while(0);
  v = jsvLock(ref);
  do { if (!(!jsvIsStringExt(v))) jsAssertFail("bin/espruino_embedded.c",2585,""); } while(0);
  jsvRef(v);
  jsvUnLock(v);
  return ref;
}
JsVarRef jsvUnRefRef(JsVarRef ref) {
  JsVar *v;
  do { if (!(ref)) jsAssertFail("bin/espruino_embedded.c",2594,""); } while(0);
  v = jsvLock(ref);
  do { if (!(!jsvIsStringExt(v))) jsAssertFail("bin/espruino_embedded.c",2596,""); } while(0);
  jsvUnRef(v);
  jsvUnLock(v);
  return 0;
}
...
JsVar *jsvNewNativeString(char *ptr, size_t len) {
  ...
  if (ptr >= 0x8000000 && (ptr < 0x8000000 +(0*1024)))
    str->flags |= JSV_CONSTANT;
  return str;
}
JsVar *jsvNewArrayBufferFromString(JsVar *str, unsigned int lengthOrZero) {
  ...
  do { if (!(arr->varData.arraybuffer.byteOffset == 0)) jsAssertFail("bin/espruino_embedded.c",2908,""); } while(0);
  ...
  if (jsvIsConstant(str))
    arr->flags |= JSV_CONSTANT;
  return arr;
}
JsVar *jsvMakeIntoVariableName(JsVar *var, JsVar *valueOrZero) {
  if (!var) return 0;
  do { if (!(jsvGetRefs(var)==0)) jsAssertFail("bin/espruino_embedded.c",2918,""); } while(0);
  do { if (!(jsvIsSimpleInt(var) || jsvIsString(var))) jsAssertFail("bin/espruino_embedded.c",2919,""); } while(0);
  ...
  if (varType==JSV_INTEGER) {
    ...
    if (((varType)==JSV_FLAT_STRING || (varType)==JSV_NATIVE_STRING || false)) {
      ...
      do { if (!(it.var == jsvGetAddressOf(jsvGetLastChild(var)) && it.charIdx == 0)) jsAssertFail("bin/espruino_embedded.c",2982,""); } while(0);
      index = 0;
      while (jsvStringIteratorHasChar(&it)) {
  ...
  } else do { if (!(0)) jsAssertFail("bin/espruino_embedded.c",3010,""); } while(0);
  if (valueOrZero)
    jsvSetFirstChild(var, jsvGetRef(jsvRef(valueOrZero)));
  return var;
}
JsVar *jsvMakeFunctionParameter(JsVar *v) {
  do { if (!(jsvIsString(v))) jsAssertFail("bin/espruino_embedded.c",3018,""); } while(0);
  if (!jsvIsName(v))
...
void jsvAddFunctionParameter(JsVar *fn, JsVar *paramName, JsVar *value) {
  do { if (!(jsvIsFunction(fn))) jsAssertFail("bin/espruino_embedded.c",3027,""); } while(0);
  if (!paramName) paramName = jsvNewFromEmptyString();
  do { if (!(jsvIsString(paramName))) jsAssertFail("bin/espruino_embedded.c",3029,""); } while(0);
  if (paramName) {
...
bool jsvIsBasicVarEqual(JsVar *a, JsVar *b) {
  if (a==b) return true;
  if (!a || !b) return false;
  do { if (!(jsvIsBasic(a) && jsvIsBasic(b))) jsAssertFail("bin/espruino_embedded.c",3057,""); } while(0);
  if (jsvIsNumeric(a) && jsvIsNumeric(b)) {
    if (jsvIsIntegerish(a)) {
      if (jsvIsIntegerish(b)) {
        return a->varData.integer == b->varData.integer;
      } else {
        do { if (!(jsvIsFloat(b))) jsAssertFail("bin/espruino_embedded.c",3063,""); } while(0);
        return a->varData.integer == b->varData.floating;
      }
    } else {
      do { if (!(jsvIsFloat(a))) jsAssertFail("bin/espruino_embedded.c",3067,""); } while(0);
      if (jsvIsIntegerish(b)) {
        return a->varData.floating == b->varData.integer;
      } else {
        do { if (!(jsvIsFloat(b))) jsAssertFail("bin/espruino_embedded.c",3071,""); } while(0);
...
size_t jsvGetString(const JsVar *v, char *str, size_t len) {
  do { if (!(len>0)) jsAssertFail("bin/espruino_embedded.c",3157,""); } while(0);
  ...
  if (s) {
    ...
    do { if (!(!jsvIsStringExt(v))) jsAssertFail("bin/espruino_embedded.c",3177,""); } while(0);
    size_t l = len;
    JsvStringIterator it;
...
size_t jsvGetStringChars(const JsVar *v, size_t startChar, char *str, size_t len) {
  do { if (!(jsvHasCharacterData(v))) jsAssertFail("bin/espruino_embedded.c",3212,""); } while(0);
  size_t l = len;
  JsvStringIterator it;
...
void jsvSetString(JsVar *v, const char *str, size_t len) {
  do { if (!(jsvHasCharacterData(v))) jsAssertFail("bin/espruino_embedded.c",3229,""); } while(0);
  JsvStringIterator it;
...
JsVar *jsvAsString(JsVar *v) {
  ...
  if (jsvHasCharacterData(v) && jsvIsName(v)) {
    ...
    do { if (!(70>=10)) jsAssertFail("bin/espruino_embedded.c",3265,""); } while(0);
    char buf[70];
    if (constChar) {
...
size_t jsvGetFlatStringBlocks(const JsVar *v) {
  do { if (!(jsvIsFlatString(v))) jsAssertFail("bin/espruino_embedded.c",3390,""); } while(0);
  return ((size_t)v->varData.integer+sizeof(JsVar)-1) / sizeof(JsVar);
}
char *jsvGetFlatStringPointer(JsVar *v) {
  do { if (!(jsvIsFlatString(v))) jsAssertFail("bin/espruino_embedded.c",3395,""); } while(0);
...
JsVar *jsvGetFlatStringFromPointer(char *v) {
  ...
  do { if (!(jsvIsFlatString(flatStr))) jsAssertFail("bin/espruino_embedded.c",3403,""); } while(0);
  return flatStr;
}
char *jsvGetDataPointer(JsVar *v, size_t *len) {
  do { if (!(len)) jsAssertFail("bin/espruino_embedded.c",3409,""); } while(0);
...
void jsvGetLineAndCol(JsVar *v, size_t charIdx, size_t *line, size_t *col, size_t *ignoredLines) {
  ...
  size_t y = 1;
  size_t n = 0;
  do { if (!(line && col)) jsAssertFail("bin/espruino_embedded.c",3475,""); } while(0);
...
void jsvAppendString(JsVar *var, const char *str) {
  do { if (!(jsvIsString(var))) jsAssertFail("bin/espruino_embedded.c",3540,""); } while(0);
...
void jsvAppendStringBuf(JsVar *var, const char *str, size_t length) {
  do { if (!(jsvIsString(var))) jsAssertFail("bin/espruino_embedded.c",3554,""); } while(0);
  JsvStringIterator dst;
  jsvStringIteratorNew(&dst, var, 0);
  jsvStringIteratorGotoEnd(&dst);
  while (length) {
...
void jsvAppendStringVar(JsVar *var, const JsVar *str, size_t stridx, size_t maxLength) {
  do { if (!(jsvIsString(var))) jsAssertFail("bin/espruino_embedded.c",3605,""); } while(0);
  JsvStringIterator dst;
  jsvStringIteratorNew(&dst, var, 0);
  jsvStringIteratorGotoEnd(&dst);
  JsvStringIterator it;
...
JsVar *jsvNewFlatStringFromStringVar(JsVar *var, size_t stridx, size_t maxLength) {
  do { if (!(jsvIsString(var))) jsAssertFail("bin/espruino_embedded.c",3625,""); } while(0);
...
JsVar *jsvNewFromStringVar(const JsVar *str, size_t stridx, size_t maxLength) {
  do { if (!(jsvIsString(str))) jsAssertFail("bin/espruino_embedded.c",3660,""); } while(0);
...
bool jsvIsStringNumericInt(const JsVar *var, bool allowDecimalPoint) {
  do { if (!(jsvIsString(var))) jsAssertFail("bin/espruino_embedded.c",3800,""); } while(0);
  JsvStringIterator it;
...
bool jsvIsStringNumericStrict(const JsVar *var) {
  do { if (!(jsvIsString(var))) jsAssertFail("bin/espruino_embedded.c",3847,""); } while(0);
  JsvStringIterator it;
  jsvStringIteratorNew(&it, (JsVar*)var, 0);
...
void jsvSetInteger(JsVar *v, JsVarInt value) {
  do { if (!(jsvIsInt(v))) jsAssertFail("bin/espruino_embedded.c",3912,""); } while(0);
...
JsVar *jsvExecuteGetter(JsVar *parent, JsVar *getset) {
  do { if (!(jsvIsGetterOrSetter(getset))) jsAssertFail("bin/espruino_embedded.c",4004,""); } while(0);
...
void jsvExecuteSetter(JsVar *parent, JsVar *getset, JsVar *value) {
  do { if (!(jsvIsGetterOrSetter(getset))) jsAssertFail("bin/espruino_embedded.c",4018,""); } while(0);
...
size_t jsvGetArrayBufferLength(const JsVar *arrayBuffer) {
  do { if (!(jsvIsArrayBuffer(arrayBuffer))) jsAssertFail("bin/espruino_embedded.c",4127,""); } while(0);
...
JsVar *jsvGetArrayBufferBackingString(JsVar *arrayBuffer, uint32_t *offset) {
  ...
  do { if (!(jsvIsString(arrayBuffer))) jsAssertFail("bin/espruino_embedded.c",4142,""); } while(0);
  return arrayBuffer;
}
...
JsVar *jsvArrayBufferGetFromName(JsVar *name) {
  do { if (!(jsvIsArrayBufferName(name))) jsAssertFail("bin/espruino_embedded.c",4166,""); } while(0);
...
JsVar *jsvGetValueOfName(JsVar *a) {
  ...
  do { if (!(!jsvIsNameWithValue(a))) jsAssertFail("bin/espruino_embedded.c",4213,""); } while(0);
...
JsVar *jsvSkipNameWithParent(JsVar *a, bool repeat, JsVar *parent) {
  ...
  while (((flags)>=_JSV_NAME_START && (flags)<=_JSV_NAME_END)) {
    ...
    do { if (!(pa!=a)) jsAssertFail("bin/espruino_embedded.c",4248,""); } while(0);
    if (!repeat) break;
  }
...
JsVar *jsvSkipToLastName(JsVar *a) {
  do { if (!(jsvIsName(a))) jsAssertFail("bin/espruino_embedded.c",4281,""); } while(0);
  a = jsvLockAgain(a);
  while (true) {
...
JsVar *jsvCopyNameOnly(JsVar *src, bool linkChildren, bool keepAsName) {
  do { if (!(jsvIsName(src))) jsAssertFail("bin/espruino_embedded.c",4409,""); } while(0);
  ...
  if (!keepAsName) {
    ...
    if (t>=_JSV_NAME_INT_START && t<=_JSV_NAME_INT_END) {
      ...
      do { if (!((JSV_NAME_STRING_INT_0 < JSV_NAME_STRING_0) && (JSV_NAME_STRING_0 < JSV_STRING_0) && (JSV_STRING_0 < JSV_STRING_EXT_0))) jsAssertFail("bin/espruino_embedded.c",4417,""); } while(0);
      do { if (!(t>=JSV_NAME_STRING_INT_0 && t<=JSV_NAME_STRING_MAX)) jsAssertFail("bin/espruino_embedded.c",4420,""); } while(0);
  ...
  if (!dst) {
    ...
    do { if (!(jsvGetLastChild(dst) == 0)) jsAssertFail("bin/espruino_embedded.c",4438,""); } while(0);
    do { if (!(jsvGetFirstChild(dst) == 0)) jsAssertFail("bin/espruino_embedded.c",4439,""); } while(0);
    do { if (!(jsvGetPrevSibling(dst) == 0)) jsAssertFail("bin/espruino_embedded.c",4440,""); } while(0);
    do { if (!(jsvGetNextSibling(dst) == 0)) jsAssertFail("bin/espruino_embedded.c",4441,""); } while(0);
    if (jsvHasStringExt(src)) {
      do { if (!(keepAsName || !jsvGetLastChild(src))) jsAssertFail("bin/espruino_embedded.c",4445,""); } while(0);
      if (jsvGetLastChild(src)) {
      ...
      do { if (!(jsvIsBasic(src))) jsAssertFail("bin/espruino_embedded.c",4457,""); } while(0);
    }
  }
...
JsVar *jsvCopy(JsVar *src, bool copyChildren) {
  ...
  if (!jsvIsStringExt(src)) {
      ...
      if (!refsAsData) {
        do { if (!(jsvGetPrevSibling(dst) == 0)) jsAssertFail("bin/espruino_embedded.c",4484,""); } while(0);
        do { if (!(jsvGetNextSibling(dst) == 0)) jsAssertFail("bin/espruino_embedded.c",4485,""); } while(0);
        do { if (!(jsvGetFirstChild(dst) == 0)) jsAssertFail("bin/espruino_embedded.c",4486,""); } while(0);
      }
      do { if (!(jsvGetLastChild(dst) == 0)) jsAssertFail("bin/espruino_embedded.c",4488,""); } while(0);
  } else {
    memcpy(&dst->varData, &src->varData, (4 + ((14*3 + 0 + 8)>>3)));
    do { if (!(jsvGetLastChild(dst) == 0)) jsAssertFail("bin/espruino_embedded.c",4493,""); } while(0);
  }
  ...
  if (jsvHasStringExt(src)) {
    ...
    do { if (!(jsvIsBasic(src))) jsAssertFail("bin/espruino_embedded.c",4557,""); } while(0);
  }
  return dst;
}
void jsvAddName(JsVar *parent, JsVar *namedChild) {
  namedChild = jsvRef(namedChild);
  do { if (!(jsvIsName(namedChild))) jsAssertFail("bin/espruino_embedded.c",4565,""); } while(0);
  ...
  if (jsvGetLastChild(parent)) {
    ...
    if (insertAfter) {
      do { if (!(jsvIsName(insertAfter))) jsAssertFail("bin/espruino_embedded.c",4587,""); } while(0);
...
JsVar *jsvAddNamedChild(JsVar *parent, JsVar *value, const char *name) {
  do { if (!(parent)) jsAssertFail("bin/espruino_embedded.c",4619,""); } while(0);
...
JsVar *jsvSetValueOfName(JsVar *name, JsVar *src) {
  do { if (!(name && jsvIsName(name))) jsAssertFail("bin/espruino_embedded.c",4632,""); } while(0);
  do { if (!(name!=src)) jsAssertFail("bin/espruino_embedded.c",4633,""); } while(0);
...
static __attribute__ ((gnu_inline)) inline bool jsvFastPrefixEqual(const char *a, const char *b) {
...
JsVar *jsvFindChildFromString(JsVar *parent, const char *name) {
  ...
  do { if (!(jsvHasChildren(parent))) jsAssertFail("bin/espruino_embedded.c",4706,""); } while(0);
...
JsVar *jsvFindChildFromStringI(JsVar *parent, const char *name) {
  do { if (!(jsvHasChildren(parent))) jsAssertFail("bin/espruino_embedded.c",4749,""); } while(0);
  JsVarRef childref = jsvGetFirstChild(parent);
  while (childref) {
    JsVar *child = jsvGetAddressOf(childref);
...
JsVar *jsvCreateNewChild(JsVar *parent, JsVar *index, JsVar *child) {
  ...
  do { if (!(!jsvGetFirstChild(newChild))) jsAssertFail("bin/espruino_embedded.c",4769,""); } while(0);
  if (child) jsvSetValueOfName(newChild, child);
  do { if (!(!jsvGetNextSibling(newChild) && !jsvGetPrevSibling(newChild))) jsAssertFail("bin/espruino_embedded.c",4771,""); } while(0);
...
void jsvRemoveChild(JsVar *parent, JsVar *child) {
  do { if (!(jsvHasChildren(parent))) jsAssertFail("bin/espruino_embedded.c",4821,""); } while(0);
  do { if (!(jsvIsName(child))) jsAssertFail("bin/espruino_embedded.c",4822,""); } while(0);
  ...
  if (jsvGetPrevSibling(child)) {
    ...
    do { if (!(jsvGetNextSibling(v) == jsvGetRef(child))) jsAssertFail("bin/espruino_embedded.c",4850,""); } while(0);
  ...
  if (jsvGetNextSibling(child)) {
    ...
    do { if (!(jsvGetPrevSibling(v) == jsvGetRef(child))) jsAssertFail("bin/espruino_embedded.c",4857,""); } while(0);
...
void jsvRemoveAllChildren(JsVar *parent) {
  do { if (!(jsvHasChildren(parent))) jsAssertFail("bin/espruino_embedded.c",4875,""); } while(0);
...
bool jsvIsChild(JsVar *parent, JsVar *child) {
  do { if (!(jsvIsArray(parent) || jsvIsObject(parent) || jsvIsFunction(parent))) jsAssertFail("bin/espruino_embedded.c",4884,""); } while(0);
  do { if (!(jsvIsName(child))) jsAssertFail("bin/espruino_embedded.c",4885,""); } while(0);
  JsVarRef childref = jsvGetRef(child);
  JsVarRef indexref;
...
JsVar *jsvObjectGetChild(JsVar *obj, const char *name, JsVarFlags createChild) {
  if (!obj) return 0;
  do { if (!(jsvHasChildren(obj))) jsAssertFail("bin/espruino_embedded.c",4902,""); } while(0);
...
JsVar *jsvObjectGetChildIfExists(JsVar *obj, const char *name) {
  if (!obj) return 0;
  do { if (!(jsvHasChildren(obj))) jsAssertFail("bin/espruino_embedded.c",4919,""); } while(0);
  return jsvSkipNameAndUnLock(jsvFindChildFromString(obj, name));
}
JsVar *jsvObjectGetChildI(JsVar *obj, const char *name) {
  if (!obj) return 0;
  do { if (!(jsvHasChildren(obj))) jsAssertFail("bin/espruino_embedded.c",4926,""); } while(0);
...
JsVarInt jsvObjectGetIntegerChildOr(JsVar *obj, const char *name, JsVarInt defaultValue) {
  ...
  do { if (!(jsvHasChildren(obj))) jsAssertFail("bin/espruino_embedded.c",4945,""); } while(0);
...
JsVar *jsvObjectSetChild(JsVar *obj, const char *name, JsVar *child) {
  do { if (!(jsvHasChildren(obj))) jsAssertFail("bin/espruino_embedded.c",4966,""); } while(0);
...
JsVar *jsvObjectSetChildVar(JsVar *obj, JsVar *name, JsVar *child) {
  do { if (!(jsvHasChildren(obj))) jsAssertFail("bin/espruino_embedded.c",4978,""); } while(0);
  if (!jsvHasChildren(obj)) return 0;
...
__attribute__ ((gnu_inline)) inline void jsvArrayBufferIteratorClone(JsvArrayBufferIterator *dstit, JsvArrayBufferIterator *it) {
  *dstit = *it;
...
__attribute__ ((gnu_inline)) inline void jspDebuggerLoopIfCtrlC() {
}
bool jspIsInterrupted() {
...
JsVar *jswBinarySearch(const JswSymList *symbolsPtr, JsVar *parent, const char *name) {
  ...
  while (searchMin <= searchMax) {
    ...
    if (cmp==0) {
      unsigned short functionSpec = (*(uint16_t*)(&sym->functionSpec));
...
static const JswSymPtr jswSymbols_global[] = {
  ...
  { 152, JSWAT_JSVAR, (void*)gen_jswrap_JSON_JSON},
  { 157, JSWAT_JSVAR, (void*)gen_jswrap_Math_Math},
  { 162, JSWAT_JSVAR, (void*)gen_jswrap_Modules_Modules},
  { 170, JSWAT_JSVARFLOAT | JSWAT_EXECUTE_IMMEDIATELY, (void*)gen_jswrap_NaN},
  { 174, JSWAT_JSVAR | (JSWAT_ARGUMENT_ARRAY << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)), (void*)jswrap_number_constructor},
  { 181, JSWAT_JSVAR | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)), (void*)jswrap_object_constructor},
  { 188, JSWAT_JSVAR | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)), (void*)jswrap_referenceerror_constructor},
...
static const JswSymPtr jswSymbols_ArrayBufferView_proto[] = {
  ...
  { 35, JSWAT_JSVAR | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*3)), (void*)jswrap_array_fill},
  { 40, JSWAT_JSVAR | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)), (void*)jswrap_array_filter},
  { 47, JSWAT_JSVAR | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)), (void*)jswrap_array_find},
  { 52, JSWAT_JSVAR | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)), (void*)jswrap_array_findIndex},
  { 62, JSWAT_VOID | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)), (void*)jswrap_array_forEach},
  { 70, JSWAT_BOOL | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)), (void*)jswrap_array_includes},
  { 79, JSWAT_JSVAR | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)), (void*)jswrap_arraybufferview_indexOf},
  { 87, JSWAT_JSVAR | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)), (void*)jswrap_array_join},
  { 92, JSWAT_JSVAR | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)), (void*)jswrap_arraybufferview_map},
  { 96, JSWAT_JSVAR | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)), (void*)jswrap_array_reduce},
  { 103, JSWAT_JSVAR | JSWAT_THIS_ARG, (void*)jswrap_array_reverse},
  { 111, JSWAT_VOID | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)), (void*)jswrap_arraybufferview_set},
  { 115, JSWAT_JSVAR | JSWAT_THIS_ARG | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)), (void*)jswrap_array_slice},
  { 121, JSWAT_JSVAR | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)), (void*)jswrap_array_some},
  { 126, JSWAT_JSVAR | JSWAT_THIS_ARG | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)), (void*)jswrap_arraybufferview_sort},
  { 131, JSWAT_JSVAR | JSWAT_THIS_ARG | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)), (void*)jswrap_arraybufferview_subarray}
};
...
static const JswSymPtr jswSymbols_Date_proto[] = {
  ...
  { 118, JSWAT_INT32 | JSWAT_THIS_ARG, (void*)jswrap_date_getUTCDate},
  { 129, JSWAT_INT32 | JSWAT_THIS_ARG, (void*)jswrap_date_getUTCDay},
  { 139, JSWAT_INT32 | JSWAT_THIS_ARG, (void*)jswrap_date_getUTCFullYear},
  { 154, JSWAT_INT32 | JSWAT_THIS_ARG, (void*)jswrap_date_getUTCHours},
  { 166, JSWAT_INT32 | JSWAT_THIS_ARG, (void*)jswrap_date_getUTCMilliseconds},
  { 185, JSWAT_INT32 | JSWAT_THIS_ARG, (void*)jswrap_date_getUTCMinutes},
  { 199, JSWAT_INT32 | JSWAT_THIS_ARG, (void*)jswrap_date_getUTCMonth},
  { 211, JSWAT_INT32 | JSWAT_THIS_ARG, (void*)jswrap_date_getUTCSeconds},
  { 225, JSWAT_JSVARFLOAT | JSWAT_THIS_ARG | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)), (void*)jswrap_date_setDate},
  { 233, JSWAT_JSVARFLOAT | JSWAT_THIS_ARG | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*3)), (void*)jswrap_date_setFullYear},
  { 245, JSWAT_JSVARFLOAT | JSWAT_THIS_ARG | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*3)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*4)), (void*)jswrap_date_setHours},
  { 254, JSWAT_JSVARFLOAT | JSWAT_THIS_ARG | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)), (void*)jswrap_date_setMilliseconds},
  { 270, JSWAT_JSVARFLOAT | JSWAT_THIS_ARG | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*3)), (void*)jswrap_date_setMinutes},
  { 281, JSWAT_JSVARFLOAT | JSWAT_THIS_ARG | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)), (void*)jswrap_date_setMonth},
  { 290, JSWAT_JSVARFLOAT | JSWAT_THIS_ARG | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)) | (JSWAT_JSVAR << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*2)), (void*)jswrap_date_setSeconds},
  { 301, JSWAT_JSVARFLOAT | JSWAT_THIS_ARG | (JSWAT_JSVARFLOAT << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)), (void*)jswrap_date_setTime},
  { 309, JSWAT_JSVAR | JSWAT_THIS_ARG, (void*)jswrap_date_toISOString},
  { 321, JSWAT_JSVAR | JSWAT_THIS_ARG, (void*)jswrap_date_toISOString},
  { 328, JSWAT_JSVAR | JSWAT_THIS_ARG, (void*)jswrap_date_toLocalISOString},
  { 345, JSWAT_JSVAR | JSWAT_THIS_ARG, (void*)jswrap_date_toString},
  { 354, JSWAT_JSVAR | JSWAT_THIS_ARG, (void*)jswrap_date_toUTCString},
  { 366, JSWAT_JSVARFLOAT | JSWAT_THIS_ARG, (void*)jswrap_date_getTime}
};
...
static const char jswSymbols_ArrayBufferView_proto_str[] = "buffer\0byteLength\0byteOffset\0every\0fill\0filter\0find\0findIndex\0forEach\0includes\0indexOf\0join\0map\0reduce\0reverse\0set\0slice\0some\0sort\0subarray\0";
...
JsVar *jswrap_arraybufferview_indexOf(JsVar *array, JsVar *valueVar, JsVarInt startIdx) {
  ...
  if (!(((array->varData.arraybuffer.type)&ARRAYBUFFERVIEW_FLOAT)!=0)) {
...
int jswrap_date_getUTCHours(JsVar *parent) {
  return getTimeFromDateVar(parent, true ).hour;
}
int jswrap_date_getUTCMinutes(JsVar *parent) {
  return getTimeFromDateVar(parent, true ).min;
}
int jswrap_date_getUTCSeconds(JsVar *parent) {
  return getTimeFromDateVar(parent, true ).sec;
}
int jswrap_date_getUTCMilliseconds(JsVar *parent) {
  return getTimeFromDateVar(parent, true ).ms;
}
int jswrap_date_getUTCDay(JsVar *parent) {
  return getCalendarDateFromDateVar(parent, true ).dow;
}
int jswrap_date_getUTCDate(JsVar *parent) {
  return getCalendarDateFromDateVar(parent, true ).day;
}
int jswrap_date_getUTCMonth(JsVar *parent) {
  return getCalendarDateFromDateVar(parent, true ).month;
}
int jswrap_date_getUTCFullYear(JsVar *parent) {
  return getCalendarDateFromDateVar(parent, true ).year;
}
JsVarFloat jswrap_date_setHours(JsVar *parent, int hoursValue, JsVar *minutesValue, JsVar *secondsValue, JsVar *millisecondsValue) {
